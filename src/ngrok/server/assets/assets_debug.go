...
func assets_server_tls_snakeoil_crt() (*asset, error) {
	path := "/home/way/gocode/src/ngrok/assets/server/tls/snakeoil.crt"
...
func assets_server_tls_snakeoil_key() (*asset, error) {
	path := "/home/way/gocode/src/ngrok/assets/server/tls/snakeoil.key"
