...
func assets_server_tls_snakeoil_key() (*asset, error) {
	bytes, err := assets_server_tls_snakeoil_key_bytes()
	if err != nil {
		return nil, err
	}

	info := bindata_file_info{name: "assets/server/tls/snakeoil.key", size: 3243, mode: os.FileMode(436), modTime: time.Unix(1423565556, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
